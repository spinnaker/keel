...
internal class StatefulConstraintEvaluatorTests : JUnit5Minutests {
  ...
  class Fixture {
    ...
    val combinedRepository: CombinedRepository = combinedMockRepository(deliveryConfigRepository = deliveryConfigRepository)
    ...
    val subject = FakeStatefulConstraintEvaluator(
      combinedRepository, eventPublisher, fakeStatefulConstraintEvaluatorDelegate)
  }
