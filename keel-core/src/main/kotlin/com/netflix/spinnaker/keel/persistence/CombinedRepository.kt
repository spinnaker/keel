 ...
 *
 */
// todo eb: this shouldn't need any special implementation to handle sql and non sql...
@Component
open class CombinedRepository(
  ...
  // from persister
  fun saveDeliveryConfig(config: DeliveryConfig): DeliveryConfig {
  ...
  open fun delete(deliveryConfigName: String): DeliveryConfig {
