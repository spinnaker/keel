...
interface LifecycleMonitorRepository {
  ...
  /**
   * Returns between zero and [limit] MonitoredThings that have not been checked (i.e. returned by this
   ...
   * different values.
   */
  fun tasksDueForCheck(type: LifecycleEventType, minTimeSinceLastCheck: Duration, limit: Int): Collection<MonitoredTask>
