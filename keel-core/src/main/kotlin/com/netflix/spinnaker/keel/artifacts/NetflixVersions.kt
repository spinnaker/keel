...
object NetflixVersions {
   ...
   */
  fun getVersionDisplayName(artifact: ArtifactInstance): String {
   ...
   */
  fun getBuildNumber(artifact: ArtifactInstance): Int? {
    return try {
   ...
   */
  fun getCommitHash(artifact: ArtifactInstance): String? {
