...
object ApplicationUpsertAssetProcessorTest {

  val front50Service = mock<Front50Service>()
  val objectMapper = ObjectMapper()

  val subject = ApplicationUpsertAssetProcessor(front50Service, objectMapper)
  ...
  fun `should update application when app is present`() {
    ...
    val result = subject.converge(ApplicationAsset(updated))
  ...
  fun `should not update if desired state has not changed`() {
    ...
    val result = subject.converge(ApplicationAsset(desired))
