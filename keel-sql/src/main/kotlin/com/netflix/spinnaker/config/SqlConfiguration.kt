...
import com.netflix.spinnaker.keel.sql.SqlUnhealthyVetoRepository
...
class SqlConfiguration {
  ...
  @Bean
  fun unhealthyVetoRepository(
    jooq: DSLContext,
    clock: Clock,
    properties: SqlProperties
  ) = SqlUnhealthyVetoRepository(clock, jooq, SqlRetry(sqlRetryProperties))
