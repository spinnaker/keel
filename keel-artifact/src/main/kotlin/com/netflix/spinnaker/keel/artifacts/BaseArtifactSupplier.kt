...
abstract class BaseArtifactSupplier<A : ArtifactSpec, V : VersioningStrategy>(
  open val artifactMetadataService: ArtifactMetadataService
) : ArtifactSupplier<A, V> {
  override suspend fun getArtifactMetadata(artifact: ArtifactInstance): ArtifactMetadata? {
